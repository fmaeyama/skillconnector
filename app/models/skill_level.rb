  ...
  class Grid < InnerGrid
    def grid_info
      [
          ...
          {field: "constraint_val", name: "value", minWidth: 20, cssClass: "row-hd", formatter: "Select2Formatter", editor:"Select2Editor", dataSource:"selList['constraint']", columnGroup:"constraint"},
          {field: "evaluation_type", name: "id", minWidth: 20, cssClass: "row-hd", editor: "Slick.Editors.Integer", columnGroup:"evaluation_type"},
          {field: "evaluation_type_val", name: "value", minWidth: 20, cssClass: "row-hd", formatter: "Select2Formatter", editor:"Select2Editor", dataSource:"selList['evaluation_type']", columnGroup:"evaluation_type"},
    ...
    def define_selector
      ...
      self.enum_field = {constraint:SkillLevel.constraints,evaluation_type:SkillLevel.evaluation_types}

      @decorator.select_arr['constraint'] = SkillLevel.constraints.map {|k, v| [v, I18n.t("level_constraint.#{k}")]}.to_h
      @decorator.select_arr['evaluation_type'] = SkillLevel.evaluation_types.map {|k, v| [v, k]}.to_h
