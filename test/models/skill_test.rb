            ...
            {"utf8"=>"✓",
                ...
                "business"=>
                    {"business_status_id"=>"2",
                        ...
                        "office_id"=>"2"},
                "hat"=>
                    {"1"=>{"0"=>{"hat_type_id"=>"1", "memo"=>"備考のテスト", "id"=>"1", "_destroy"=>"0"}},
                        "2"=>{"0"=>{"hat_type_id"=>"3", "memo"=>"備考", "id"=>"3", "_destroy"=>"0"}, "1"=>{"hat_type_id"=>"4", "memo"=>"", "id"=>"2", "_destroy"=>"0"}},
                ...
                "skill"=>
                    ...
                    "2"=>
                        {"0"=>
                            {"skill_type_id"=>"", "memo"=>"", "id"=>"-1", "_destroy"=>"0"}
                        },
                    "3"=>
                        {"0"=>
                            {"skill_type_id"=>"", "memo"=>"", "id"=>"-1", "_destroy"=>"0"}
